...
const animationStyles = `
  ...
  .date-step-input {
    position: relative;
    padding-right: 44px !important;
    /* iOS Safari applies an internal min-width to input[type=date] that
       ignores width/max-width and forces it to its intrinsic content size,
       causing it to overflow its container. Zeroing it out lets our own
       width rules (w-full max-w-xs) take effect on iOS too. */

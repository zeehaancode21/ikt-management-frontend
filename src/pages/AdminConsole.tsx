...
//               <rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" />
//             </svg>
//             <p>{search ? "No matching projects" : "No projects yet — add one above"}</p>
//           </motion.div>
//         ) : (
...
//         .ac-table-row { 
//           display: grid; 
//           grid-template-columns: 2fr 1.2fr 0.9fr 0.9fr 0.9fr 0.9fr 60px; 
//           gap: 12px; 
//           width: 100%;
//         }
...
//           .ac-table-header, 
//           .ac-table-row { 
//             grid-template-columns: 1.8fr 1.1fr 0.8fr 0.8fr 0.8fr 0.8fr 50px; 
//             gap: 8px;
//           }
...
//           .ac-table-header, 
//           .ac-table-row { 
//             grid-template-columns: 1.5fr 1fr 0.7fr 0.7fr 0.7fr 0.7fr 45px; 
//             gap: 6px;
//           }
...
//         .ac-project-name-cell .ac-name-text {
//           flex: 1;
//           line-height: 1.4;
